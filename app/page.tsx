    ...
    <div className="relative min-h-screen">
      <div className="main">
        <ImageCard
          ...
          subCaption="На картинке мой пёсик, если что"
        />
        <ScrollArea className="rounded-base h-[120px] w-[350px] text-main-foreground border-2 border-border bg-main p-4 shadow-shadow">
          На этой странице вы можете найти ссылки на мои социальные сети и мой GitHub.
        </ScrollArea>
